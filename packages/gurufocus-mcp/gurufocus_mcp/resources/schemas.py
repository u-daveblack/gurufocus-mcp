...
returned by tools, enabling them to write correct Python/SQL analysis code.
"""
...
def register_schema_resources(mcp: FastMCP) -> None:
    ...
    to understand data structures and write correct analysis code.
    ...
    async def get_schema(model_name: str) -> dict[str, Any]:
        ...
        This enables you to write correct Python code to analyze the data, e.g.:
        - Know exact field names for pandas DataFrame operations
        ...
        if model_class is None:
            ...
            error_msg += f" Use gurufocus://schemas to list all available schemas."
